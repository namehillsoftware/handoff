...
public class WhenTheCancellationIsCalled {
	...
	public static void before() {
		...
		final Promise<Object> cancellablePromise = promise.eventually((result) -> new Promise<>((messenger) -> messenger.awaitCancellation((() -> messenger.sendRejection(thrownException)))));
