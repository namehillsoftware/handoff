...
public class CollectedErrorExcuse<TResult> implements ImmediateResponse<Throwable, Throwable> {
	...
	public CollectedErrorExcuse(Messenger<Collection<TResult>> messenger, Collection<PromiseLike<TResult>> promises) {
		this.messenger = messenger;
		for (PromiseLike<TResult> promise : promises) promise.excuse(this);
	}
